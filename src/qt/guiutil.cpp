...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("SelfDirectedCoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("SelfDirectedCoin://"))
    {
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SelfDirectedCoin.lnk";
}
...
{
    return GetAutostartDir() / "SelfDirectedCoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("SelfDirectedCoin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("SelfDirectedCoin-Qt"));
